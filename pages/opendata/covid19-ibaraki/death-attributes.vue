<template>
  ...
  covid19_ibaraki {
    death_attributes( [PAGINATION INFO] ) {
      dataset {
        no               <span class="token comment"># {{$t('死亡者の通し番号')}}: Int!</span>
  ...
  data() {
    ...
    return {
      breadcrumb_data: [
        ...
        {
          to: '/opendata/covid19-ibaraki/death-attributes/',
          text: this.$t(title),
          active: true,
        },
      ],
      ...
      title,
      description:
        '茨城県内の、新型コロナウイルスによる死亡者の属性を集計したオープンデータです。',
      coverage: '2020-01-31/..',
      dl_url:
        'https://a01sa01to.com/opendata/api/raw/covid19_ibaraki/080004_ibaraki_covid19_death_attributes.csv',
      keywords: ['COVID-19 > JAPAN > IBARAKI > ATTRIBUTES OF THE DEAD'],
    }
  },
})
</script>
