  ...
  covid19_ibaraki {
    call_center( [PAGINATION INFO] ) {
      dataset {
        ...
        value            <span class="token comment"># {{$t('相談件数')}}: Int!</span>
      }
      pageinfo {
  ...
  data() {
    ...
    return {
      breadcrumb_data: [
        ...
        {
          to: '/opendata/covid19-ibaraki/call-center/',
          text: this.$t(title),
          active: true,
        },
      ],
      ...
      coverage: '2020-01-31/..',
      dl_url:
        'https://a01sa01to.com/opendata/api/raw/covid19_ibaraki/080004_ibaraki_covid19_call_center.csv',
      keywords: ['COVID-19 > JAPAN > IBARAKI > NUMBER OF CONSULTATIONS'],
    }
  },
})
</script>
