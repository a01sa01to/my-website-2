<template>
  <div>
    <shared-main-header :title="$t('陽性確認数')" :b_data="breadcrumb_data" />
    <b-container>
      <p>
        {{
          $t(
    ...
    <b-container>
      ...
      <opendata-metadata
        ...
        file_name="080004_ibaraki_covid19_positive_number.csv"
        :file_size="size"
        data_format="csv"
      />
    </b-container>
    ...
    <b-container>
      ...
      <opendata-url-dl-copy
        url="https://a01sa01to.com/opendata/api/raw/covid19_ibaraki/080004_ibaraki_covid19_positive_number.csv"
        file_name="080004_ibaraki_covid19_positive_number.csv"
      />
    </b-container>
    <b-container>
  ...
  covid19_ibaraki {
    positive_number( [PAGINATION INFO] ) {
      dataset {
        ...
        positive         <span class="token comment"># {{$t('陽性者数')}}: Int!</span>
        close_contact    <span class="token comment"># {{$t('陽性者数のうち、濃厚接触者数')}}: Int!</span>
      }
      pageinfo {
  ...
  data() {
    return {
      breadcrumb_data: [
        ...
        {
          to: '/opendata/covid19-ibaraki/positive-number/',
          text: this.$t('陽性確認数'),
          active: true,
        },
      ],
