...
export default Vue.extend({
  ...
  data() {
    const title = '検査実施人数（県衛生研究所・水戸市保健所実施分）'
    return {
      breadcrumb_data: [
        { to: '/', text: 'Home' },
      ...
      coverage: '2020-01-26/..',
      dl_url:
        'https://a01sa01to.com/opendata/api/raw/covid19_ibaraki/080004_ibaraki_covid19_test_people.csv',
      keywords: ['COVID-19 > JAPAN > IBARAKI > NUMBER OF PERSONS INSPECTED'],
    }
  },
})
</script>
