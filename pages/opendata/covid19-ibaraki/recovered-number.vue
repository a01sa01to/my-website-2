<template>
  <div>
    <shared-main-header :title="$t('回復確認数')" :b_data="breadcrumb_data" />
    <b-container>
      <p>
        {{
          $t('茨城県における公表日別の回復確認数を集計したオープンデータです。')
        }}
      </p>
    </b-container>
    <b-container>
      ...
      <opendata-metadata
        ...
        file_name="080004_ibaraki_covid19_recovered_number.csv"
        :file_size="size"
        data_format="csv"
      />
    </b-container>
    ...
    <b-container>
      ...
      <opendata-url-dl-copy
        url="https://a01sa01to.com/opendata/api/raw/covid19_ibaraki/080004_ibaraki_covid19_recovered_number.csv"
        file_name="080004_ibaraki_covid19_recovered_number.csv"
      />
    </b-container>
    <b-container>
